...
class QKDTransferApp(QWidget):
    ...
    def initUI(self):
        ...
        # Window properties
        self.setWindowTitle('Quantum Vaults')
    ...
    def init_connection_screen(self):
        ...
        # display auto-detected location
    ...
    def init_main_interface(self):
        ...
        self.client_label = QLabel('Run vault with:')
        ...
        self.listening_label = QLabel('Listening for incoming requests...')
        ...
        # bold title label
        self.about_label = QLabel('<b>Quantum Vaults:</b> Unconditionally-secure QKD key aggregator')
        ...
        self.about_label_github = QLabel('<a href="https://github.com/QuantumUPB/QKD-App-Vaults">GitHub Repository</a>')
    ...
    def set_send_button_state(self):
        if self.client_dropdown.currentText() and not self.task_type:
            self.send_button.setEnabled(True)
        else:
    ...
    def update_timer(self):
        ...
        self.status_bar.showMessage(f'{"Generating vault with"} {self.counterparty} [{elapsed_time // 60 :02d}:{(elapsed_time % 60):02d} elapsed]')
    ...
    def end_progress(self):
        self.timer.stop()
        self.status_bar.showMessage(f'Successfully generated vault with {self.counterparty}!')
    ...
    def add_sending_file(self):
        ...
        self.file_send_worker.add_file(selected_client, self.location, client_location)
